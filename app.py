...
os.system(f"pip install torchmetrics==0.11.4")
...
if "IS_SHARED_UI" in os.environ:
    ...
    os.system(f"wget -q https://huggingface.co/Lykon/DreamShaper/resolve/main/DreamShaper_7_pruned.safetensors -O /home/user/app/stable-diffusion-webui/models/Stable-diffusion/DreamShaper_7_pruned.safetensors")
